...
const Listings = () => {
    ...
    const applyFilter = () => {
        // Check if bedrooms and bathrooms are selected
        if (filter.bedrooms === '' || filter.bathrooms === '') {
            alert('Please select the number of bedrooms and bathrooms.');
            return;
        }
                ...
                {isFilterVisible && (
                    <div className="filter-row">
                        ...
                        <div className="filter-input">
                            <label>Bedrooms<span className="required-indicator">*</span>:</label>
                            <select
                                name="bedrooms"
                        ...
                        <div className="filter-input">
                            <label>Bathrooms<span className="required-indicator">*</span>:</label>
                            <select
                                name="bathrooms"
